        ...
        <van-form @submit="onSubmit" ref="loginFormRef">
            ...
            <van-field
                ...
                <template #button>
                    ...
                    <van-button @click="onSendSms" round size="small" type="default" class="send-sms-btn" native-type="button" v-else>>发送验证码</van-button>
                </template>
            </van-field>
  ...
  methods: {
    ...
    async onSubmit () {
        ...
        this.$toast.loading({
            ...
            duration: 0 // 持续时间,默认2000ms,如果为0则持续展示
        })
        // 提交表单请求登录
        try {
